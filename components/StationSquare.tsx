  ...
  return (
    <TouchableOpacity onPress={() => {
      ...
      <View style={{
        ...
        <Text style={{color: 'white', textAlign: 'center', fontWeight: 'bold'}}>{index == destinationIndex? <Entypo name="flag" size={13} color="white" /> : <FontAwesome name="map-pin" size={13} color="red" />}{' ' + text}</Text>
      </View>
      <View style={{
            width: 0,
            height: 0,
